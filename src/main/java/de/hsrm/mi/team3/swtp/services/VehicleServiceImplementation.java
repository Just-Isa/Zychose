...
public class VehicleServiceImplementation implements VehicleService {
    ...
    private void move(Vehicle vehicle) {
        vehicle.setPosX((DISTANCE * vehicle.getCurrentSpeed() * Math.sin(vehicle.getRotationY())) + vehicle.getPosX());
        vehicle.setPosZ((DISTANCE * vehicle.getCurrentSpeed() * Math.cos(vehicle.getRotationY())) + vehicle.getPosZ());
