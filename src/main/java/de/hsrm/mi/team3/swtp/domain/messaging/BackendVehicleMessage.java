 ...
 */
public record BackendVehicleMessage(double postitionX, double postitionY, double postitionZ, double rotationX,
        double rotationY, double rotationZ, double speed) {
