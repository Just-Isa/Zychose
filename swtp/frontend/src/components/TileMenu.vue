...
<template>
    <footer>
        ...
        <div class="tilemenuwrapper">
            ...
            <div class="tilemenu">
                <Tile @click="setStreetType()" class="street" :tile="streetTile" :imgurl="street"></Tile>
                <Tile @click="setCrossType()" class="cross" :tile="crossTile" :imgurl="street"></Tile>
                <Tile @click="setCurveType()" class="curve" :tile="curveTile" :imgurl="street"></Tile>
                <Tile @click="setTCrossType()" class="tcross" :tile="tcrossTile" :imgurl="street"></Tile>
            </div>
        </div>
...
import street from './icons/straight-road.png';
